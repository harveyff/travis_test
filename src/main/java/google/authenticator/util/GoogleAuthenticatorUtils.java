package google.authenticator.util;
...
import google.authenticator.org.ietf.tools.TOTP;
...
public class GoogleAuthenticatorUtils {
	...
	public static String createGoogleAuthQRCodeData(String secret, String account, String issuer) {
		...
		try {
			return String.format(qrCodeData, issuer + ":" + account.replace("+", "%20"), URLEncoder.encode(secret, "UTF-8")
