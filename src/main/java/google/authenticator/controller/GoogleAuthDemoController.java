package google.authenticator.controller;
...
import com.bytetrade.pro.bytemodule.chain.Authority;

import google.authenticator.util.GoogleAuthenticatorUtils;


public class GoogleAuthDemoController {
	public static Logger log4j = LogManager.getLogger(GoogleAuthDemoController.class);
	/**
	 * 生成包含用户信息,密钥的二维码图片
	 */
