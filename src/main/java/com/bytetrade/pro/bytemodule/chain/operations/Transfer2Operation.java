 ...
 */
public class Transfer2Operation extends BaseOperation {
    ...
    public Transfer2Operation(JSONObject o) {
        super(OperationType.TRANSFER2_OPERATION);
        ...
        try {
            ...
            if( o.has("message")) {
                message = new Optional<ByteString>(new ByteString(o.getString("message")));
            } else {
                message = new Optional<ByteString>(null);
            }
    ...
    public Optional<ByteString> message;

    public Transfer2Operation(){
        super(OperationType.TRANSFER2_OPERATION);
    ...
    public JSONArray toJsonObject() {
        ...
        try {
            ...
            if( this.message != null && this.message.isNull() == false ) {
    ...
    public List<Byte> toBytes() {
        ...
        byteArray.addAll(  this.message.toBytes());
