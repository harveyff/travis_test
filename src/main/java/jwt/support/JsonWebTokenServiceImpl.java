...
public class JsonWebTokenServiceImpl implements JsonWebTokenService {
    ...
    private static final String base64Security = "b164e75f6bfc36da3e45c2858137f4af"; // 签名密钥

   // private static final String issuer = "harvey";// 签发者
    //private static final String audience = "pengpeng";// 审阅者

    private static final int TTLMins = 30 ;// 30分钟

    private static final long LASTTTLMills = 0;
